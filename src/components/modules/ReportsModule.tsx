...
const REPORTS = [
  {id:'RPT-2024-Q1',title:'Q1 Inspection Summary',type:'Quarterly',date:'2024-01-31',status:'published'},
  {id:'RPT-2024-SAF',title:'Safety Compliance Report',type:'Safety',date:'2024-01-28',status:'published'},
  {id:'RPT-2024-PRJ',title:'Project Monitoring Report',type:'Projects',date:'2024-01-25',status:'draft'},
  {id:'RPT-2024-ARM',title:'Armoury Serviceability',type:'Armoury',date:'2024-01-20',status:'review'},
];
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div><h1 className="text-2xl font-black text-white">Reports</h1><p className="text-sm text-slate-500 mt-0.5">Analytics and performance reports</p></div>
        <Select value={period} onValueChange={setPeriod}>
          ...
          <SelectContent style={{background:'#060818',borderColor:`${C.dark}60`}}>
            {[['q1','Q1 2024'],['q4','Q4 2023'],['q3','Q3 2023']].map(([v,l])=>(
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          <div key={i} className="rounded-xl p-4 flex items-center gap-3"
            ...
            <div>
              <p className="text-xs text-slate-600 uppercase tracking-wider">{k.label}</p>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="rounded-2xl p-5" style={{background:'rgba(4,6,22,0.8)',border:`1px solid ${C.dark}50`}}>
          ...
          <ResponsiveContainer width="100%" height={180}>
            <AreaChart data={trendData}>
              ...
              <Tooltip contentStyle={{background:'#060818',border:`1px solid ${C.dark}60`,borderRadius:8,color:'#fff'}}/>
      ...
      <div className="rounded-2xl overflow-hidden" style={{border:`1px solid ${C.dark}50`}}>
        ...
        <div style={{background:'rgba(4,6,22,0.8)'}}>
          {REPORTS.map((r,i)=>(
            <div key={r.id} className={`flex items-center gap-4 px-5 py-4 transition-all ${i<REPORTS.length-1?'border-b':''}`}
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-slate-600">{r.type} · {r.date}</p>
              </div>
