...
import { getCommandMetrics } from '../services/analytics';
      ...
      <DashboardSection title="Platform Metrics" subtitle="Aggregate performance across projects, inspections and safety">
        <MetricGrid
          ...
          metrics={[
            ...
            { label: 'Total Assessments',     value: 12,                      color: 'text-slate-300',   note: 'Safety assessments' },
            { label: 'Inspection Modules',    value: 5,                       color: 'text-slate-300',   note: 'Active templates' },
            { label: 'Registered Projects',   value: 8,                       color: 'text-slate-300',   note: 'All directorates' },
          ]}
        />
      </DashboardSection>
